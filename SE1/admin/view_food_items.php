...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="view_food_items.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  View Food
                Items</a>
...
if (mysqli_num_rows($result) > 0)
{
  ...
  <tbody>
    <tr>
      ...
      <td><img src="<?php echo $row["img_path"]; ?>" style="width:40px" alt=""></td>
